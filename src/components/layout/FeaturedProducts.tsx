...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  return (
    <div className="relative w-full max-w-[430px] mx-auto h-[400px] xs:h-[350px] sm:h-[400px] md:h-[380px] lg:h-[450px] overflow-hidden rounded-lg group ">
      <div
...
const ProductCarousel: React.FC = () => {
  ...
  return (
    <div className="w-full px-4 xs:px-6 sm:px-8 py-8 sm:py-12">
